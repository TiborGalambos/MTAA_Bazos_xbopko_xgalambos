...
class ItemListAdapter(private val context: Context,
    ...
    override fun getView(position: Int, convertView: View?, parent: ViewGroup): View? {
        ...
        author.text = authors[position]!!.removeRange(1,1)
        category.text = categories[position]!!.removeRange(1,1)
        title.text = titles[position]!!.removeRange(1,1)
        content.text = contents[position]!!.removeRange(1,1)
